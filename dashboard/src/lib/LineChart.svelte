<script>
  ...
  import { InfoCircleSolid, ChevronRightSolid, ChevronDownSolid, FileLinesSolid } from 'flowbite-svelte-icons';
...
<Card>
  <div class="flex justify-between mb-5">
    ...
    <div>
      <Button color="light" class="px-3 py-2">Last week<ChevronDownSolid class="w-2.5 h-2.5 ms-1.5" /></Button>
      <Dropdown class="w-40">
